...
return array(
	...
	'MODULE_ALLOW_LIST'     => array('Home', 'chijiao_manager', 'Install'),
	'URL_MODULE_MAP'        => array('chijiao_manager'=>'admin'), //隐藏真实后台入口地址，开启后需要在MODULE_ALLOW_LIST中替换对应的模块名

	/* 数据库设置 */
	'DB_TYPE'               => 'mysqli',      // 数据库类型
	'DB_HOST'               => 'localhost',   // 服务器地址
	'DB_NAME'               => 'news_cjdx_supper_poj',         // 数据库名
	'DB_USER'               => 'root',        // 用户名
	'DB_PWD'                => 'moma',            // 密码
	'DB_PORT'               => '3306',        // 端口
	'DB_PREFIX'             => 'news_cjdx_',       // 数据库表前缀
